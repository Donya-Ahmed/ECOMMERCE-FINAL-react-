      ...
      <div className="collapse navbar-collapse" id="collapsibleNavId">
        ...
        <i className="fa-brands mx-2  fa-tiktok"></i>
          ...
          {userData?<><li className="nav-item">
            ...
            <Link className="nav-link position-relative" to="/cart"><i className="fa-solid fa-cart-shopping fa-lg "></i><span className='spanCart'>{numOfProducts?numOfProducts:'0'}</span></Link>
          </li></>:<>
          <li className="nav-item">
